...
?>
	               ...
	               or username like '%$qcari%'  ";
                                ...
                                <table id="example" class="table table-hover table-bordered">
                                    <thead>
                                        <tr>
                                            <th>
                                                <center>User ID <i class="fa fa-sort"></i></center>
                                            </th>
                                            <th>
                                                <center>Email <i class="fa fa-sort"></i></center>
                                            </th>
                                            <th>
                                                <center>Password <i class="fa fa-sort"></i></center>
                                            </th>
                                            <th>
                                                <center>Fullname <i class="fa fa-sort"></i></center>
                                            </th>
                                            <th>
                                                <center>Foto <i class="fa fa-sort"></i></center>
                                            </th>
                                            <th>
                                                <center>Tools</center>
                                            </th>
                                    ...
                                    <?php while ($data = mysqli_fetch_array($tampil)) { ?>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <center>
                                                        <div id="thanks"><a class="btn btn-sm btn-primary" data-placement="bottom" data-toggle="tooltip" title="Edit Admin" href="edit-admin.php?hal=edit&kd=<?php echo $data['user_id']; ?>"><span class="glyphicon glyphicon-edit"></span></a>
    ...
    <div class="footer-main">
            Desain by : <a href="https://www.instagram.com/pmiiteknik_uninus/"><i>Biro Media Rayon Teknik</i></a>
            </div>
    </aside><!-- /.right-side -->
