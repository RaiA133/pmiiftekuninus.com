...
<head>
    ...
    <link href="<?php echo base_url() . 'assets/backend/plugins/weather-icons-master/css/weather-icons.min.css' ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo base_url() . 'assets/backend/plugins/metrojs/MetroJs.min.css' ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo base_url() . 'assets/backend/plugins/toastr/toastr.min.css' ?>" rel="stylesheet" type="text/css" />
...
<body class="page-header-fixed compact-menu pace-done page-sidebar-fixed">
        ...
        <div class="page-sidebar sidebar">
            <div class="page-sidebar-inner slimscroll">
                ...
                <ul class="menu accordion-menu">
                    ...
                    <li><a href="../e-book/login_a.html" class="waves-effect waves-button"><span class="menu-icon icon-dislike"></span>
                            <p>Perpus Admin</p>
                        </a></li>
    ...
    <script src="<?php echo base_url() . 'assets/backend/plugins/jquery-counterup/jquery.counterup.min.js' ?>"></script>
    ...
    <script src="<?php echo base_url() . 'assets/backend/plugins/flot/jquery.flot.time.min.js' ?>"></script>
    <script src="<?php echo base_url() . 'assets/backend/plugins/flot/jquery.flot.symbol.min.js' ?>"></script>
    <script src="<?php echo base_url() . 'assets/backend/plugins/flot/jquery.flot.resize.min.js' ?>"></script>
    <script src="<?php echo base_url() . 'assets/backend/plugins/flot/jquery.flot.tooltip.min.js' ?>"></script>
    <script src="<?php echo base_url() . 'assets/backend/plugins/chartsjs/Chart.min.js' ?>"></script>
    <script src="<?php echo base_url() . 'assets/backend/js/modern.js' ?>"></script>
