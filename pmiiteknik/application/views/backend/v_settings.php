                            ...
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea name="description" class="form-control" rows="6" id="summernote"><?php echo $site_description; ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <img src="<?php echo base_url() . 'assets/frontend/images/' . $site_favicon; ?>" class="thumbnail">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <img src="<?php echo base_url() . 'assets/frontend/images/' . $site_logo_header; ?>" class="thumbnail">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <img src="<?php echo base_url() . 'assets/frontend/images/' . $site_logo_big; ?>" width="560" class="thumbnail">
                                        </div>
                                    </div>
