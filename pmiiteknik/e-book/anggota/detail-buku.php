...
?>
    ...
    <head>
        <meta charset="UTF-8">
        <title>Perpustakaan Rayon</title>
    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <!-- <aside class="left-side sidebar-offcanvas"> -->
            ...
            <section class="sidebar">
                ...
                <div class="user-panel">
                    <div>
                        <center><img src="<?php echo $_SESSION['foto']; ?>" height="80" width="80" class="img-circle" alt=" " style="border: 3px solid white;" /></center>
                    </div>
                    <div class="info">
                        <center>
        ...
        <aside class="right-side">
            ...
            <div class="footer-main">
                Copyright <a href="https://www.instagram.com/pmiiteknik_uninus/"><i>Biro Media Rayon Teknik</i></a>
            </div>
        </aside><!-- /.right-side -->
