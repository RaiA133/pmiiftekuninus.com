...
<head>
    ...
    <link href="<?php echo base_url() . 'assets/backend/css/dropify.min.css' ?>" rel="stylesheet" type="text/css" media="screen,projection">
    <link href="<?php echo base_url() . 'assets/backend/plugins/sum/summernote-lite.min.css' ?>" rel="stylesheet">
                        ...
                        <div class="col-md-4">
                            <div class="panel panel-white">
                                <div class="panel-body">
                                    <div class="form-group">
                                        <label>Image</label>
                                        <input type="file" name="filefoto" class="dropify" data-height="190" data-default-file="<?php echo base_url() . 'assets/backend/images/post/' . $b['post_image']; ?>">
                                    </div>
                                    <div class="form-group">
