                            ...
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle waves-effect waves-button waves-classic" data-toggle="dropdown">
                                    ...
                                    if ($query->num_rows() > 0) :
                                        $row = $query->row_array();
                                    ?>
                                        <img class="img-circle avatar" src="<?php echo base_url() . 'assets/backend/images/' . $row['user_photo']; ?>" width="30" height="30" alt="">
                                    <?php else : ?>
                                        <img class="img-circle avatar" src="<?php echo base_url() . 'assets/backend/images/logokomi.png'; ?>" width="30" height="30" alt="">
                                    <?php endif; ?>
                                </a>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <p class="help-block">Image Heading harus beresolusi 1215 x 872 Pixels.</p>
                                            <img src="<?php echo base_url() . 'assets/frontend/images/' . $image_heading; ?>" width="560" class="thumbnail">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label for="input1" class="col-sm-2 control-label">Image Profil</label>
                                        <div class="col-sm-10">
                                            <input type="file" name="img_testimonial" class="form-control" id="input1">
                                            <p class="help-block">Image profil harus beresolusi 1043 x 663 Pixels.</p>
                                            <img src="<?php echo base_url() . 'assets/frontend/images/' . $image_testimonial; ?>" width="560" class="thumbnail">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label for="input1" class="col-sm-2 control-label">Image Keanggotaan</label>
                                        <div class="col-sm-10">
                                            <input type="file" name="img_testimonial2" class="form-control" id="input1">
                                            <p class="help-block">Image keanggotaan harus beresolusi 726 x 790 Pixels.</p>
                                            <img src="<?php echo base_url() . 'assets/frontend/images/' . $image_testimonial2; ?>" width="560" class="thumbnail">
                                        </div>
                                    </div>
