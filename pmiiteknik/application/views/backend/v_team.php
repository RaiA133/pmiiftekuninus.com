...
<body class="page-header-fixed  compact-menu  pace-done page-sidebar-fixed">
        ...
        <div class="page-sidebar sidebar">
            <div class="page-sidebar-inner slimscroll">
                ...
                <ul class="menu accordion-menu">
                    ...
                    <li><a href="<?php echo site_url('gabung/list_anggota'); ?>" class="waves-effect waves-button"><span class="menu-icon icon-users"></span>
                            <p>New Members</p>                    
                    <li><a href="<?php echo site_url('backend/testimonial'); ?>" class="waves-effect waves-button"><span class="menu-icon icon-like"></span>
                            <p>Testimonials</p>
                        </a></li>
                    <li class="active"><a href="<?php echo site_url('backend/team'); ?>" class="waves-effect waves-button"><span class="menu-icon icon-users"></span>
                            <p>Teams</p>
                        </a></li>
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <?php if (empty($row->team_image)) : ?>
                                                        <img class="img-circle" width="50" src="<?php echo base_url() . 'assets/backend/images/team/user_blank.jpg'; ?>">
                                                    <?php else : ?>
                                                        <img class="img-circle" width="50" src="<?php echo base_url() . 'assets/backend/images/team/' . $row->team_image; ?>">
                                                    <?php endif; ?>
                                                </td>
                                                <td style="vertical-align: middle;"><?php echo $row->team_name; ?>
                                                </td>
                                                <td style="vertical-align: middle;"><?php echo $row->team_org; ?>
                                                </td>
                                                <!-- <td style="vertical-align: middle;"><?php echo $row->team_content; ?>
                                            </td> -->
                                                <td style="vertical-align: middle;"><?php echo $row->team_twitter; ?>
                                                </td>
                                                <td style="vertical-align: middle;"><?php echo $row->team_facebook; ?>
                                                </td>
                                                <td style="vertical-align: middle;"><?php echo $row->team_instagram; ?>
                                                </td>
                                                <td style="vertical-align: middle;"><?php echo $row->team_linked; ?>
                                                </td>
                                                <td style="vertical-align: middle;">
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                                            <li><a href="javascript:void(0);" data-toggle="modal" data-target="#ModalEdit<?php echo $row->team_id; ?>"><span class="icon-pencil"></span> Edit</a></li>
                                                            <li><a href="javascript:void(0);" class="delete" data-userid="<?php echo $row->team_id; ?>"><span class="icon-trash"></span> Delete</a></li>
                                                        </ul>
                                                    </div>
                                                </td>
                                            </tr>
    ...
    <!-- Modal -->
    <form id="add-row-form" action="<?php echo base_url() . 'backend/team/insert' ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    <textarea name="content" class="form-control" rows="6" placeholder="Content" disabled></textarea>
                                </div>
    ...
    ?>
        <!-- Modal -->
        <form id="add-row-form" action="<?php echo base_url() . 'backend/team/update' ?>" method="post" enctype="multipart/form-data">
            <div class="modal fade" id="ModalEdit<?php echo $row->team_id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="file" name="filefoto" class="dropify" data-height="180" data-default-file="<?php echo base_url() . 'assets/backend/images/team/' . $row->team_image; ?>">
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <input type="text" name="nama" value="<?php echo $row->team_name; ?>" class="form-control" placeholder="Name" required>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" name="jabatan" value="<?php echo $row->team_org; ?>" class="form-control" placeholder="Jabatan" required>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" name="twitter" value="<?php echo $row->team_twitter; ?>" class="form-control" placeholder="https://twitter.com/" required>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" name="facebook" value="<?php echo $row->team_facebook; ?>" class="form-control" placeholder="https://facebook.com/" required>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" name="instagram" value="<?php echo $row->team_instagram; ?>" class="form-control" placeholder="https://instagram.com/" required>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" name="linked" value="<?php echo $row->team_linked; ?>" class="form-control" placeholder="https://linkedin.com/" required>
                                    </div>
                                    <div class="form-group">
                                        <textarea name="content" class="form-control" rows="6" placeholder="Content" disabled><?php echo $row->team_content; ?></textarea>
                                    </div>
                        ...
                        <div class="modal-footer">
                            <input type="hidden" name="team_id" value="<?php echo $row->team_id; ?>" required>
                            <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
    ...
    <!-- Modal hapus-->
    <form id="add-row-form" action="<?php echo base_url() . 'backend/team/delete' ?>" method="post" enctype="multipart/form-data">
